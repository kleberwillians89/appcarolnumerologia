...
const PRODUCT_ALIASES: Record<string, string> = {
  ...
  'nome-profissional-marca': 'mapa',
  'data-cesarea': 'mapa',
  'nome-bebe': 'mapa',
  'abertura-empresa': 'mapa',
  'mapa-numerologico-pessoal': 'mapa',
  'mapa-crianca': 'mapa',
  'mapa-adolescente': 'mapa',
  'orientacao-vocacional-profissional': 'mapa',
  'sinastria-casal': 'mapa',
  'mentoria-individual': 'mapa',
  'revisao-numerologica-anual': 'ano_pessoal',
